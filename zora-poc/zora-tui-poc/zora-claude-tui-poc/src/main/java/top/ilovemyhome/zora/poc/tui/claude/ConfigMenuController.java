...
/** Controls the interactive configuration menu for the Claude-like TUI shell. */
final class ConfigMenuController {
    ...
    ConfigMenuController(LineReader lineReader, PrintWriter writer, ClaudeTuiConfigRepository repository) {
        if (lineReader == null) {
    ...
    private ClaudeTuiConfig chooseModel(ClaudeTuiConfig draft) {
    ...
    private ClaudeTuiConfig chooseTheme(ClaudeTuiConfig draft) {
    ...
    private ClaudeTuiConfig chooseStreamDelay(ClaudeTuiConfig draft) {
    ...
    private void printMainMenu(ClaudeTuiConfig draft) {
